package com.example.demoandroid.entity;
...
import com.example.demoandroid.util.PxConvertUtil;
...
public class TextDrawable extends Drawable {
	...
	public void draw(Canvas canvas) {
		...
		canvas.translate(mMarginLeft + mPaddingLeft, mMarginTop + mPaddingTop); ///�ѵ�ǰ������ԭ���Ƶ�(10,10),����Ĳ�������(10,10)��Ϊ�ο���
		//canvas.translate(mMarginLeft + mPaddingLeft, 0 + mPaddingTop);
