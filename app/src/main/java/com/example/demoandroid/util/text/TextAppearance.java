...
public class TextAppearance {
    ...
    public TextAppearance(@NonNull Context context, @StyleRes int id) {
        textSize = 16;
        textColor = ColorStateList.valueOf(Color.parseColor("#ff0000"));
        textColorHint = ColorStateList.valueOf(Color.parseColor("#ff0000"));
        textColorLink = ColorStateList.valueOf(Color.parseColor("#ff0000"));
        ...
        fontFamily = null;
        textAllCaps = false;
        shadowColor = ColorStateList.valueOf(Color.parseColor("#ff0000"));
