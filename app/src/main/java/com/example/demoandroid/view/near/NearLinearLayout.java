package com.example.demoandroid.view.near;
...
public class NearLinearLayout extends LinearLayout {
    public NearLinearLayout(Context context) {
        super(context);
    }

    public NearLinearLayout(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }
